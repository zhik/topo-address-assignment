<script>
  ...
  function _set(addr) {
    fetch(
      `https://cors-anywhere.herokuapp.com/https://api.cityofnewyork.us/geoclient/v1/bbl.json?borough=manhattan&block=${block}&lot=${lot}&app_id=d2a49e32&app_key=c8c857bdc19eb8829bf9fa5a920df18c`
    )
